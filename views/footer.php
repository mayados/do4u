            ...
            <div class="row mb-4">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <ul class="ps-0 footer-element__dropdown" aria-label="Catégories d'annonces">
                        <li><a href="ads.php" class="small">Ménage</a></li>
                        <li><a href="ads.php" class="small">Services à la personne</a></li>
                        <li><a href="ads.php" class="small">Rénovation & construction</a></li>
                        <li><a href="ads.php" class="small">Jardinage & bricolage</a></li>
                        <li><a href="ads.php" class="small">Réparation & maintenance</a></li>
                        <li><a href="ads.php" class="small">Informatique & administratif</a></li>
                        <li><a href="ads.php" class="small">Cours & coaching</a></li>
                        <li><a href="ads.php" class="small">Santé & bien-être</a></li>
                        <li><a href="ads.php" class="small">Animaux</a></li>
                        <li><a href="ads.php" class="small">Artisanat & création</a></li>
                        <li><a href="ads.php" class="small">Garde d'enfants</a></li>
                        <li><a href="ads.php" class="small">Autre</a></li> 
                    </ul>                        
                </div>
                <div class="col-12 col-lg-2 footer-element__container-nous-contacter">
                    ...
                    <ul class="ps-0">
                        <li class="footer-element__mobile--hidden"><a href="contact.php" class="small">Qui sommes-nous ?</a></li>
                        <li class="text-center text-lg-start footer-element__nous-contacter-link"><a href="contact.php" class="small">Nous contacter</a></li>
                        <li class="footer-element__mobile--hidden"><a href="ads.php" class="small">Les offres</a></li>
                        <li class="footer-element__mobile--hidden"><a href="ads.php" class="small">Les demandes</a></li>
                    </ul>
                </div>
        ...
        <section class="container py-2">
            <div class="d-flex gap-4 flex-column text-center gap-lg-0 text-lg-start flex-lg-row justify-content-lg-between mb-0 footer-element__infos">
                <ul class="d-flex gap-4 flex-column flex-lg-row ps-0 mb-0 gap-lg-3 pt-2">
                    <li><a href="cgu.php" class="small">Conditions générales d'utilisation</a></li>
                    <li><a href="politique.php" class="small">Politique de confidentialité</a></li>
                </ul>
